            ...
            <div class="mb-4">
                ...
                <%
                    try {
                        ...
                        String query = 
                            "SELECT u.username, SUM(r.total_cost) AS total_revenue " +
                            "FROM reservations r " +
                        ...
                        out.println("<thead><tr><th>Customer</th><th>Total Revenue ($)</th></tr></thead>");
                        out.println("<tbody>");
                        while (rs.next()) {
                        ...
                        e.printStackTrace();
                        out.println("<div class='alert alert-danger'>Error fetching revenue by customer.</div>");
                    }
                %>
            </div>
